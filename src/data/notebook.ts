...
/* Стартовых заметок здесь нет: тетрадь начинается пустой, всё содержимое — своё */
...
/* Сначала текстовая разметка — в языковых заметках она нужна чаще формул, формулы следом */
