    ...
    <main className="checks-page">
      <header className="page-head">
        ...
        <p className="page-head__lead">
          Каждую субботу — без новой грамматики: повтор недели и небольшой тест самому себе вслух, лучше на диктофон. Каждое задание отмечаете кнопкой — получилось, наполовину или нет; неотмеченное считается как «не получилось», и балл теста растёт от нуля вверх. Раз в
