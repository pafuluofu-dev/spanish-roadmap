...
import { fmtDateYear, todayISO } from '../dates'
    ...
    <main className="notebook">
      <header className="page-head">
        ...
        <p className="page-head__lead">
          Свои конспекты по грамматике, списки слов и шпаргалки. Разметка простая: заголовки, списки, таблицы, жирный; при желании формулы в{' '}
                ...
                return (
                  <li key={note.id}>
                    ...
                    >
                      ...
                      <span className="notebook__item-meta">{fmtDateYear(note.updatedAt)}</span>
          ...
          <article className="notebook__view" aria-labelledby="notebook-view-title">
            <header className="notebook__view-head">
              ...
              <p className="notebook__view-meta">
                создано {fmtDateYear(current.createdAt)}
                {current.updatedAt !== current.createdAt && ` · изменено ${fmtDateYear(current.updatedAt)}`}
              </p>
            </header>
    ...
    >
      <div className="notebook__field">
        ...
        <input
          ...
          type="text"
          value={title}
          placeholder="Например: ser и estar — когда какой"
      ...
      <div className="notebook__pane">
        <div className="notebook__field">
          ...
          <textarea
            ...
            value={body}
            spellCheck={false}
            placeholder={'## Заголовок\n\nТекст, **термин** и список:\n\n- ser — кто ты, откуда, профессия\n- estar — где ты, как дела'}
